//
//  EZGLSkySphereGeometry.m
//  Pods
//
//  Created by wangyang on 2016/11/18.
//
//

#import "EZGLSkySphereGeometry.h"
#import "EZGLGeometryUtil.h"
#import "UIImage+GL.h"

@interface EZGLSkySphereGeometry ()
...
@implementation EZGLSkySphereGeometry
- (instancetype)initWithRadius:(CGFloat)radius segments:(CGFloat)segments ring:(CGFloat)ring {
    ...
    if (self) {
        ...
        self.material.diffuseMap = [UIImage textureFromCGImage:[UIImage imageNamed:@"sky.jpg"].CGImage];
